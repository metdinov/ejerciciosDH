package Objetos.Adicionales;

import Objetos.Ejercicio2.Atleta;
import Objetos.Ejercicio2.Prueba;
...
public class Main {
    public static void main(String[] args) {
        Objetos.Ejercicio2.Atleta usain = new Objetos.Ejercicio2.Atleta("Usain Bolt", 10, 100);
        Objetos.Ejercicio2.Atleta cabito = new Atleta("Cabito", 2, 50);
